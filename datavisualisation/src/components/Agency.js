...
const agency = {
  ...
  projects: [
...

      {
        ...
        image_url: "https://images.squarespace-cdn.com/content/v1/526597fae4b08e763cbf0389/1550179279894-ADBP11ZQP0ZOSHM3WMLD/ke17ZwdGBToddI8pDm48kD_8fTrfgG8p0_cDoTbpamQUqsxRUqqbr1mOJYKfIPR7LoDQ9mXPOjoJoqy81S2I8PaoYXhp6HxIwZIk7-Mi3Tsic-L2IOPH3Dwrhl-Ne3Z2KMNufQQ-6LzTaq8C03wdVYUGhCLxLqtho8B4fMxfqTgfdurHDt8XjyaGurlSWvQe/Apollo-Poster.jpg?format=750w"
      },
  ...
  render() {
    return (
      <div class="container agency-wrapper">
        ...
        <div class="agency-main-info">
          <div class="row">
            ...
            <div class="col-md-9 agency-name-div">
              ...
              <div>
                <span class="agency-full-name">{this.state.agency.full_name}</span>
              </div> {/*END */}
              <div class="agency-country-div">
                <span>Country:</span><span class="agency-country"> {this.state.agency.country}</span>
              </div> {/*END */}

            </div> {/*END .agency-name-div*/}

            <div class="agency-est-div col-md-3">
              <div class="agency-country-div center">
                <span>EST:</span><span class="agency-country"> {this.state.agency.est}</span>
              </div> {/*END */}
            </div> {/*END .agency-est-div*/}

            <div class="agency-desc-div col-md-9">
              <p>{this.state.agency.description}</p>
            </div> {/*END .agency-desc-div*/}
          </div> {/*END .row*/}
        </div> {/*END .agency-main-info*/}

        <div class="agency-projects-wapper">
          <h3 class="agency-projects">{ this.state.agency.name + " Projects" } </h3>
                ...
                return (
                  <div class="card">
                    ...
                    <div class="card-block">
                      <a class="card-title project-name" data-toggle="collapse" href={"#collapse"+value.id} aria-expanded="false" aria-controls="collapseExample">{value.name}</a>
                      ...
                      <p class="card-text">
                        <span class="project-duration">{value.start_date} - {value.end_date}</span>
                      </p>
                    </div>
                  </div>
                );
        ...
        </div> {/*END agency-projects-wapper*/}
